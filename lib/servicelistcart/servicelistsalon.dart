...
class Service_list_salon extends StatefulWidget {
  ...
  const Service_list_salon(
      {Key key,
        this.salonid,
        this.categories,
        this.categorie_name,
        this.profile, this.clinics, this.salons, })
      : super(key: key);

  @override
  State<Service_list_salon> createState() => _Service_list_salonState();
}

class _Service_list_salonState extends State<Service_list_salon> {
                            ...
                            Expanded(
                                child: MaterialButton(
                                  ...
                                  onPressed: () => Navigator.pushReplacement(context,
                                      MaterialPageRoute(builder: (context) => Chart_salon(
                                          salons:widget.salons,
                                          servicedata:servicesubcontroller.text
                                      ),)),
                                  child: Text(
