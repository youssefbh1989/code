...
import 'package:salonat/pages/Chart/Chart_artist.dart';
...
import '../pages/Chart/Chart_salon.dart';

class Service_list_artist extends StatefulWidget {
  final int salonid;
  ...
  const Service_list_artist(
      {Key key,
        this.salonid,
        this.categories,
        this.categorie_name,
        this.profile, this.clinics, this.salons,this.artists })
      : super(key: key);

  @override
  State<Service_list_artist> createState() => _Service_list_artistState();
}

class _Service_list_artistState extends State<Service_list_artist> {
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          // title: Text(widget.salonid.toString(),
          //     style: TextStyle(
          //         color: whiteColor,
          //         fontSize: 15.sp,
                            ...
                            Expanded(
                                child: MaterialButton(
                                  ...
                                  onPressed: () => Navigator.pushReplacement(context,
                                      MaterialPageRoute(builder: (context) => Chart_artist(
                                          artists:widget.artists,
                                              artistid:widget.salonid
                                      ),)),
                                  child: Text(
