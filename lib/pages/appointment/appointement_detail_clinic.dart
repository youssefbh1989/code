...
class AppointmentDetailsClinics extends StatefulWidget {
  final Object tag;
  final String image;
  final String name;
  ...
  const AppointmentDetailsClinics(
      {Key key,
      this.tag,
      this.image,
      this.name,
  ...
  @override
  State<AppointmentDetailsClinics> createState() =>
      _AppointmentDetailsClinicsState();
}

class _AppointmentDetailsClinicsState extends State<AppointmentDetailsClinics> {
  double height;
  double width;
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: NetworkImage(
                                'http://salonat.qa/' + widget.clinics.image),
                            fit: BoxFit.fill,
                          ),
                        ),
                      ),
