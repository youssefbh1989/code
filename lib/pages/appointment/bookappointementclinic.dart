...
class BookAppointementClinic extends StatefulWidget {
  const BookAppointementClinic({
    Key key,
    this.salon,
    this.categories,
    this.service,
  ...
  @override
  State<BookAppointementClinic> createState() => _BookAppointementClinicState();
}

class _BookAppointementClinicState extends State<BookAppointementClinic> {
                                    ...
                                    children: [
                                      ...
                                      Text(
                                          Languages.of(context)
                                              .labelSelectLanguage ==
                                              'English'
                                              ? widget.clinics.address
                                              : widget.clinics.addressAr,
        ...
        Padding(
          ...
          child: InkWell(
            onTap: () => widget.staff == null
              ...
              context,
              MaterialPageRoute(
                  builder: (context) => AppointmentDetailsClinics(
