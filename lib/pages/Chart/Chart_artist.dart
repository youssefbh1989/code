...
import 'package:salonat/pages/scheduleAppointment/ScheduleAppointmentArtist.dart';
...
class Chart_artist extends StatefulWidget {
  final ClinicModel clinics;
  final SalonModel salons;
  final ArtistModel artists;
  final int artistid;
  const Chart_artist({Key key, this.clinics, this.salons,this.artists, this.artistid}) : super(key: key);

  @override
  State<Chart_artist> createState() => _Chart_artistState();
}

class _Chart_artistState extends State<Chart_artist> {
        ...
        Padding(
          ...
          child: GestureDetector(
            onTap: () => Navigator.pushReplacement(
                context,
                MaterialPageRoute(
                    builder: (context) => ScheduleAppointmentArtist(
