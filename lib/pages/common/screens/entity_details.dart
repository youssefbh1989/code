    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      setState(() {
        ...
        if (_entity is! ArtistModel) {
          _tabs
            ..insert(1,
                {'title':Languages.of(context).service, 'widget': _categoryPage()})
    ...
    return Obx(() => Padding(
      ...
      child: _entity.value.categories.isEmpty
          ? Padding(
            ...
            child: Center(
              child: Text('No Service availaible',
                          ...
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) => ServiceList(
                                    ...
                                    categoryNameAr:
                                    _entity.value.categories[index].nameAr),
                              ));
                        },
                        trailing: Text('View',
                            style: TextStyle(
                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          child: Align(
                            ...
                            child: InkWell(
                              onTap: (){
                                API.USER == null ? _loginAlert : _review ;
                              },
                              child: Container(
                                  height: 6.h,
                                  decoration: BoxDecoration(
